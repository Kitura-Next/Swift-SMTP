...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Kitura-Next/BlueSocket.git", from: "0.12.0"),
        .package(url: "https://github.com/Kitura-Next/BlueSSLService.git", from: "0.12.0"),
        .package(url: "https://github.com/Kitura-Next/BlueCryptor.git", from: "0.8.0"),
        .package(url: "https://github.com/Kitura-Next/LoggerAPI.git", from: "1.7.0"),
        ],
    targets: [
        .target(
